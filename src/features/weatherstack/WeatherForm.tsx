...
const weatherType = ({ weatherCode }: { weatherCode: number }) => {
    ...
    if (timeOfTheDay > 20 && timeOfTheDay < 6) {
        return weatherCode === 116
            ? { bgImage: NightPartiallyCloudy, fontStyle: 1 }
            : weatherCode === 119 ||
              weatherCode === 122 ||
              weatherCode === 143 ||
              weatherCode === 248 ||
              weatherCode === 260
            ? { bgImage: NightCloudy, fontStyle: 1 }
            : weatherCode === 200 ||
              weatherCode === 386 ||
              weatherCode === 389 ||
              weatherCode === 392 ||
              weatherCode === 395
            ? { bgImage: NightThunderstorm, fontStyle: 1 }
            : weatherCode === 176 ||
              weatherCode === 185 ||
              weatherCode === 263 ||
              weatherCode === 266 ||
              ...
              weatherCode === 353 ||
              weatherCode === 359
            ? { bgImage: NightRainy, fontStyle: 1 }
            : weatherCode === 179 ||
              weatherCode === 182 ||
              weatherCode === 227 ||
              weatherCode === 230 ||
              ...
              weatherCode === 374 ||
              weatherCode === 377
            ? { bgImage: NightSnow, fontStyle: 1 }
            : { bgImage: NightClear, fontStyle: 1 };
    }
    // day time
    else if (timeOfTheDay > 9 && timeOfTheDay < 17) {
        return weatherCode === 116
            ? { bgImage: DayPartiallyCloudy, fontStyle: 2 }
            : weatherCode === 119 ||
              weatherCode === 122 ||
              weatherCode === 143 ||
              weatherCode === 248 ||
              weatherCode === 260
            ? { bgImage: DayCloudy, fontStyle: 1 }
            : weatherCode === 200 ||
              weatherCode === 386 ||
              weatherCode === 389 ||
              weatherCode === 392 ||
              weatherCode === 395
            ? { bgImage: DayThunderstorm, fontStyle: 2 }
            : weatherCode === 176 ||
              weatherCode === 185 ||
              weatherCode === 263 ||
              weatherCode === 266 ||
            ...
            : weatherCode === 179 ||
              ...
              weatherCode === 374 ||
              weatherCode === 377
            ? { bgImage: DaySnow, fontStyle: 2 }
            : { bgImage: DayClear, fontStyle: 1 };
    }
    // twilight
    else {
        return weatherCode === 116
            ? { bgImage: TwilightPartiallyCloudy, fontStyle: 2 }
            : weatherCode === 119 ||
              weatherCode === 122 ||
              weatherCode === 143 ||
              weatherCode === 248 ||
              weatherCode === 260
            ? { bgImage: TwilightCloudy, fontStyle: 2 }
            : weatherCode === 200 ||
              weatherCode === 386 ||
              weatherCode === 389 ||
              weatherCode === 392 ||
              weatherCode === 395
            ? { bgImage: TwilightThunderstorm, fontStyle: 1 }
            : weatherCode === 176 ||
              weatherCode === 185 ||
              weatherCode === 263 ||
              weatherCode === 266 ||
              ...
              weatherCode === 353 ||
              weatherCode === 359
            ? { bgImage: TwilightRainy, fontStyle: 1 }
            : weatherCode === 179 ||
              weatherCode === 182 ||
              weatherCode === 227 ||
              weatherCode === 230 ||
    ...
    return (
        <section
            ...
            style={{
                ...
                color: weatherFormFontColor,
            }}
        >
            <div
                className="weatherForm__header weatherForm__section"
                style={{ backgroundColor: weatherFormBgColor }}
            >
                <img
                    className="weatherForm__header--weatherIcon"
                    src={weatherData.current?.weather_icons[0]}
                    alt="weather icon"
                />
                <p className="weatherForm__header--p">
            ...
            <div
                className="weatherForm__body weatherForm__section"
                style={{ backgroundColor: weatherFormBgColor }}
            >
                <div className="weatherForm__body--item">
                    ...
                    {weatherData.current?.wind_degree && (
                        <Compass angle={weatherData.current?.wind_degree} />
                    )}
                </div>
                <div className="weatherForm__body--item">
                    <p>Feels like</p>
