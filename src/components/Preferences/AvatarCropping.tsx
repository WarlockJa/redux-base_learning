...
// creates Blob image based on the original image and a crop data
function getCroppedImg(image: HTMLImageElement, pixelCrop: Crop, fileName: string): Promise<Blob> {
...
const AvatarCropping = ({ imageFile, cancelEdit, acceptEdit }: { imageFile: File; cancelEdit: () => void; acceptEdit: (avatar: string) => void }) => {
    // crop state
